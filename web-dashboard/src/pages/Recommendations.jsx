...
const RECOMMENDATIONS = [
  {
    ...
    Icon: BookOpen,
    description:
      'An excellent everyday reading device with a lightweight design and long battery life. Great for focused reading, studying, and carrying a full library anywhere you go without distractions.',
  ...
  },
  {
    ...
    Icon: Laptop,
    description:
      'A simple change that quietly fixes posture, raises your screen to eye level, keeps your laptop cooler during long sessions, and folds flat for travel between desks.',
  ...
  },
  {
    ...
    Icon: Zap,
    description:
      'A sugar-free energy drink for long afternoons and pre-workout focus. Crisp flavor, easy to keep stocked, and useful when you need a clean boost.',
  ...
  },
  {
    ...
    Icon: Lamp,
    description:
      'Soft adjustable lighting that is easier on the eyes during late work or early mornings and helps your desk feel calmer and more focused.',
  ...
  },
  {
    ...
    Icon: Headphones,
    description:
      'A strong upgrade for deep work. They cut through office, cafe, and travel noise so you can actually think for a solid uninterrupted stretch.',
  ...
  },
  {
    ...
    Icon: CupSoda,
    description:
      'The non-carbonated Celsius option for the same clean energy without fizz. Easy to sip through a long session or workout and not overly sweet.',
...
export default function Recommendations() {
  return (
    <div className="space-y-8">
      <section className="overflow-hidden rounded-3xl border border-slate-200/70 bg-gradient-to-b from-white to-slate-50">
        <div className="max-w-4xl px-6 py-12 sm:px-8 sm:py-16">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-slate-600 sm:text-xl">
            ...
            This collection is based on usefulness, quality, and everyday value.
            Once you send the Amazon links, we can wire each button directly.
          </p>
        </div>
      </section>
